  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-gray-400 font-bold text-2xl lg:text-4xl sm:text-5xl md:text-6xl mt-4"
      >
        Don&apos;t Just Design Interfaces, Create Great Experiences
      </motion.h2>
      ...
      >
        I am a highly skilled professional with a passion for <span className="text-AAsecondary"> UI/UX design</span> and  <span className="text-AAsecondary">software development</span>.
         With a solid background in both areas, I had 3 years of experience in UI/UX design and 3,5 years in software development.
      ...
      <motion.div
        ...
        className="mt-12"
      >
        <a href={"https://drive.google.com/file/d/1mqMad9S3OkMt9AdXNy0j4ISY5pcrCash/view?usp=sharing"} target={"_blank"} rel="noreferrer">
