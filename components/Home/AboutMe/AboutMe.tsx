      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                My journey as a UI/UX designer has allowed me to work on a diverse array of projects, from designing user-friendly mobile apps to optimizing, interactives'  for web platform.
                What excites me most about design is its power to solve problems and enhance the human experience. 
                I'm dedicated to staying updated with the latest design trends and emerging technologies to consistently deliver innovative and effective solutions.
              </span>
            </div>
