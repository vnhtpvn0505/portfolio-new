...
import Company03 from "./Descriptions/Company03";
import Company02 from "./Descriptions/Company02";
import Company01 from "./Descriptions/Company01";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Company01");
  return (
