...
export default function Home() {
  ...
  const meta = {
    title: "Huynh Tan Phuc - UI/UX Design-Product Design-BA",
    description: ``,
  ...
  return (
    ...
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://huynhtanphuc.com`} />
        <link rel="canonical" href={`https://huynhtanphuc.com`} />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer bebUrl={"https://www.behance.net/huynhphuv"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
